...
type ModelBuildModel struct {
	...
	ProjectID      *string    `gorm:"type:uuid;index:idx_build_project"`
	FolderID       *string    `gorm:"type:uuid;index:idx_build_folder"`
	SourceModelID  *string    `gorm:"type:uuid;index:idx_build_source_model"`
